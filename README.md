...
Generated by `mcapi benchmark` → `artifacts/results/results.md`. Numbers below are a
**template**; fill in with your hardware's output. (Illustrative example values shown in
italics — replace them.)

| Model | Accuracy | F1 (macro) | Params (M) | Size (MB) | Latency bs=1 (ms) | Throughput bs=32 (ex/s) | Peak mem (MB) |
|-------|---------:|-----------:|-----------:|----------:|------------------:|------------------------:|--------------:|
| teacher (BERT-base) | _0.924_ | _0.923_ | _109.5_ | _417.7_ | _—_ | _—_ | _—_ |
| student-finetuned (DistilBERT) | _0.___ | _0.___ | _67.0_ | _268.0_ | _—_ | _—_ | _—_ |
| student-distilled | _0.___ | _0.___ | _67.0_ | _268.0_ | _—_ | _—_ | _—_ |
| student-quantized (int8) | _0.___ | _0.___ | _67.0_ | _~68_ | _—_ | _—_ | _—_ |
| student-onnx (int8) | _0.___ | _0.___ | _67.0_ | _~68_ | _—_ | _—_ | _—_ |

**Concurrent load test** (`scripts/bench_concurrent.py`, fill in):

| Backend | Concurrency | Throughput (req/s) | p50 (ms) | p95 (ms) | p99 (ms) |
|---------|------------:|-------------------:|---------:|---------:|---------:|
| quantized | 20 | _—_ | _—_ | _—_ | _—_ |
| torch (fp32) | 20 | _—_ | _—_ | _—_ | _—_ |

**How to read it:** distillation should recover most of the teacher's accuracy at ~60%
of the parameters; int8 quantization then cuts model size ~4× and reduces CPU latency,
usually with <1 pt accuracy drop. That accuracy-vs-cost gap is the headline result.
